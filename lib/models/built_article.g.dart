...
class _$BuiltArticle extends BuiltArticle {
  ...
  _$BuiltArticle._(
      ...
      this.descendants})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'BuiltArticle', 'id');
    BuiltValueNullFieldError.checkNotNull(by, r'BuiltArticle', 'by');
    BuiltValueNullFieldError.checkNotNull(time, r'BuiltArticle', 'time');
    BuiltValueNullFieldError.checkNotNull(kids, r'BuiltArticle', 'kids');
  }
      ...
      _$result = _$v ??
          new _$BuiltArticle._(
              id: BuiltValueNullFieldError.checkNotNull(
                  id, r'BuiltArticle', 'id'),
              deleted: deleted,
              type: type,
              by: BuiltValueNullFieldError.checkNotNull(
                  by, r'BuiltArticle', 'by'),
              time: BuiltValueNullFieldError.checkNotNull(
                  time, r'BuiltArticle', 'time'),
              text: text,
              dead: dead,
              parent: parent,
              poll: poll,
